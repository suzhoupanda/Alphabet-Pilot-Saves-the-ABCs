...
extension Coin{
    ...
    static let goldAnimationTurn = SKAction.animate(with: [
    ...
    static let silverAnimationTurn = SKAction.animate(with: [
    ...
    static let bronzeAnimationTurn = SKAction.animate(with: [
