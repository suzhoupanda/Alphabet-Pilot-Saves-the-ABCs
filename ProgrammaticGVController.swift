//
//  ProgrammaticGVController.swift
...
class ProgrammaticGVController: UIViewController {
    ...
    override func viewWillLayoutSubviews() {
        ...
        let tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(ProgrammaticGVController.transitionToLevelViewController(sender:)))
    ...
    func registerForNotifications(){
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(ProgrammaticGVController.startGame(notification:)), name: Notification.Name.LevelChosenNotification, object: nil)
    }
