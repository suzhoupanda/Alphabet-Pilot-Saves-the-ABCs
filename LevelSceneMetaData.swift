...
extension LevelSceneMetaData{
    ...
    static let allLevels: [LevelSceneMetaData] = [
        ...
        LevelSceneMetaData(letterScene: .LetterK_Scene, previewImage: #imageLiteral(resourceName: "LetterK_Scene"), titleText: "Letter K", subTitleText: "K is for Killer Fly", descriptionText: "The key is the key to winning!", onDemandResourceTags: nil),
