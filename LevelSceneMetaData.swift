...
extension LevelSceneMetaData{
    ...
    static let allLevels: [LevelSceneMetaData] = [
        ...
        LevelSceneMetaData(letterScene: .LetterM_Scene, previewImage: #imageLiteral(resourceName: "PreviewSample"), titleText: "Letter M", subTitleText: "M is for Monkey", descriptionText: "Fly through the clouds, but beware of the Monkey heads!", onDemandResourceTags: nil),
        LevelSceneMetaData(letterScene: .LetterN_Scene, previewImage: #imageLiteral(resourceName: "PreviewSample"), titleText: "Letter N", subTitleText: "N is for Nefarious Snake", descriptionText: "Can you navigate past the nasty, nefarious desert snakes?", onDemandResourceTags: nil),
        LevelSceneMetaData(letterScene: .LetterO_Scene, previewImage: #imageLiteral(resourceName: "PreviewSample"), titleText: "Letter O", subTitleText: "O is for Obnoxious Penguin", descriptionText: "Oh no! The obnoxious penguins are such obstalces!", onDemandResourceTags: nil),
        ...
        LevelSceneMetaData(letterScene: .LetterR_Scene, previewImage: #imageLiteral(resourceName: "PreviewSample"), titleText: "Letter R", subTitleText: "R is for Rabbit", descriptionText: "Remember to run away from rampant rabbits!", onDemandResourceTags: nil),
        ...
        LevelSceneMetaData(letterScene: .LetterU_Scene, previewImage: #imageLiteral(resourceName: "PreviewSample"), titleText: "Letter U", subTitleText: "U is for Underground Snake", descriptionText: "Find the letter U, but beware of the snakes underground...", onDemandResourceTags: nil),
