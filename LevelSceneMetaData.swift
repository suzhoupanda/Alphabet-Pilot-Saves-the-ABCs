...
extension LevelSceneMetaData{
    ...
    static let allLevels: [LevelSceneMetaData] = [
        ...
        LevelSceneMetaData(letterScene: .LetterL_Scene, previewImage: #imageLiteral(resourceName: "LetterL_Scene"), titleText: "Letter L", subTitleText: "L is for Large Panda Heads", descriptionText: "Large panda heads will try to stop you from getting to the Letter L.", onDemandResourceTags: nil),
        ...
        LevelSceneMetaData(letterScene: .LetterV_Scene, previewImage: #imageLiteral(resourceName: "LetterV_Scene"), titleText: "Letter V", subTitleText: "V is for Volcano", descriptionText: "Find the letter V, try to get past the vicious volcanoes", onDemandResourceTags: nil),
